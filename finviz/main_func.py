...
def get_stock(ticker):
    ...
    title = page_parsed.cssselect('div[class="fv-container"]')[0]
    data = {}
    data["Ticker"] = page_parsed.cssselect('h1[class="js-recent-quote-ticker quote-header_ticker-wrapper_ticker"]')[0].text_content().strip()
    try:
        company_details = page_parsed.cssselect('h2[class="quote-header_ticker-wrapper_company text-xl"]')[0]
    except IndexError:
        company_details = page_parsed.cssselect('h2[class="quote-header_ticker-wrapper_company"]')[0]
